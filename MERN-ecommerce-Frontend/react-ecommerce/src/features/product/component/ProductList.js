...
// import { ChevronLeftIcon, ChevronRightIcon, Squares2X2Icon, StarIcon } from '@heroicons/react/24/solid';
// import { ChevronDownIcon, FunnelIcon, MinusIcon, PlusIcon } from '@heroicons/react/24/solid';
              ...
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                  <div className="group relative border-solid border-2 p-2 border-gray-200">
                    ...
                    <div className="mt-4 flex justify-between">
                      <div>
                        <h3 className="text-sm text-gray-700">
                          <a href={product.thumbnail} className="group-hover:underline">
                            {product.title}
                          </a>
                        </h3>
                        <p className="mt-1 text-sm text-gray-500">
